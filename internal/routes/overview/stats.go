...
// fetchClickStats returns totalClicks, avgDailyClicks, clickDelta in a single query.
// Total is derived from the date series sum, eliminating a redundant COUNT(*) scan.
func fetchClickStats(db dbx.Builder, uid string) (totalClicks, avgDailyClicks, clickDelta int) {
